...
const OrderNoHasProductsError_1 = require("../src/error/OrderNoHasProductsError");
const OrderRepository_1 = require("../src/repository/OrderRepository");
const ProductsService_1 = require("../src/service/ProductsService");
const ProductNoHasStockError_1 = require("../src/error/ProductNoHasStockError");
class OrderService {
    constructor() {
